...
import TrungAgriBox from "./pages/projects/TrungAgriBox"
  ...
  return (
    ...
    <Router>
      ...
      <Routes>
        ...
        <Route path="/projects/ecom-angular" element={<TrungRealtime/>} />
        <Route path="/projects/movie" element={<TrungMovie/>} />
        <Route path="/projects/agribox" element={<TrungAgriBox/>} />
