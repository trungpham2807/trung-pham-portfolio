        ...
        <div className="background-black">
             <div className="container ">
                <div className="row background-black pb-5 pt-5">
                    <h1>Projects</h1>
                    <p>I've worked on a range of accessible websites, web-apps and IoT products</p>
                    ...
                    <div className="row">
                        ...
                        <div className="col-6">
                            <h3>IoT Agriculture Box</h3>
                            <Link to="/projects/agribox">
                                <Card className="home-card">
                                    <Card.Img className="home-card-image" variant="top" src={agribox} />
                                </Card>
                            </Link>
                            <p>An IoT agriculture Box collect sensors data and automatic control</p>
                        </div>
                    </div>
